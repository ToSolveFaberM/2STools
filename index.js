...
exports.mapping = {
    ...
    water_Press_ID: [0x8000 + 50, 4, null, "float"],
    ...
    junta: [0x8000 + 76, 2, null, "uint"],
    inspetor: [0x8000 + 77, 2, null, "uint"],
    operador: [0x8000 + 78, 2, null, "uint"],
    tempI: [0x8000 + 79, 2, null, "uint"],
    tempP: [0x8000 + 80, 2, null, "uint"],
    tempF: [0x8000 + 81, 2, null, "uint"],
    timeP: [0x8000 + 82, 2, null, "uint"],
    curvaA: [0x8000 + 83, 2, null, "uint"],
    curvaD: [0x8000 + 84, 2, null, "uint"],
    tolMin: [0x8000 + 85, 2, null, "uint"],
    tolMax: [0x8000 + 86, 2, null, "uint"],
    tolAscSup: [0x8000 + 87, 2, null, "uint"],
    tolAscInf: [0x8000 + 88, 2, null, "uint"],
    tolDescSup: [0x8000 + 89, 2, null, "uint"],
    tolDescInf: [0x8000 + 90, 2, null, "uint"],
    almTolMin: [0x8000 + 91, 2, null, "uint"],
    almTolMax: [0x8000 + 92, 2, null, "uint"],
    almAsc: [0x8000 + 93, 2, null, "uint"],
    almDesc: [0x8000 + 94, 2, null, "uint"],
    almPatamar: [0x8000 + 95, 2, null, "uint"],
    aux1: [0x8000 + 96, 2, null, "uint"],
    aux2: [0x8000 + 97, 2, null, "uint"],
    aux3: [0x8000 + 98, 2, null, "uint"],
    aux4: [0x8000 + 99, 2, null, "uint"],
    aux5: [0x8000 + 100, 2, null, "uint"],
    aux6: [0x8000 + 101, 2, null, "uint"],
    aux7: [0x8000 + 102, 2, null, "uint"],
    aux8: [0x8000 + 103, 2, null, "uint"],
    aux9: [0x8000 + 104, 2, null, "uint"],
    aux10: [0x8000 + 105, 2, null, "uint"]
};
